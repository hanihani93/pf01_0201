...
$(window).resize(function(){
	...
	var options = {
		center: new daum.maps.LatLng(37.435258, 126.690743), //지도의 중심좌표.
	...
	var marker = new daum.maps.Marker({
		position: new daum.maps.LatLng(37.435258, 126.690743)
	});
...
$('#contact-form').on('submit', function(e) {
		...
		//앞에두개 본인거로...
		emailjs.sendForm('hhnee22', 'template_6eQa2hD3', this).then(function(res){
